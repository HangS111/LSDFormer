...
#     def __init__(self, dim):
#         super(DEConv, self).__init__()
#         # Only keep the standard Conv2d
#         self.conv = nn.Conv2d(dim, dim, 3, padding=1, bias=True)
#
#         self.bn = nn.BatchNorm2d(dim)
#         self.act = Conv.default_act  # Make sure this is properly defined elsewhere
#
#     def forward(self, x):
#         res = self.conv(x)
#
...
#
#     def switch_to_deploy(self):
#         # In this simplified version, switch_to_deploy doesn't need to do anything
#         # since we're already using a single standard convolution
#         pass
#
#         # Optionally, you could fuse conv and bn here if desired:
